...
export default function JSPWellnessPage() {
  return (
    <main>
      <div>
        <div>
          <div className="h-auto bg-neutral-800 px-8 rounded-xl">
            <div className="max-w-4xl m-auto">
              <div className="grid grid-cols-1 gap-6">
                ...
                <div>
                  <Image
                    src="/images/jspwellness/hero.png"
                    alt="JSP Wellness Hero"
                    width={800}
                    height={450}
          ...
          <div className="max-w-4xl m-auto my-16 px-8">
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/concept-design.png"
                alt="JSP Concept Design"
                width={800}
                height={450}
                className="my-4"
              />
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/with-supporting-text.png"
                alt="JSP Logo with Supporting Text"
                width={800}
                height={450}
                className="my-4"
              />
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/typography.png"
                alt="JSP Typography"
                width={800}
                height={450}
                className="my-4"
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/color-scheme.png"
                alt="JSP Color Scheme"
                width={800}
                height={450}
                className="my-4"
              />
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/final-design.png"
                alt="JSP Final Design"
                width={800}
                height={450}
                className="my-4"
              />
            ...
            <div className="my-4">
              <Image
                src="/images/jspwellness/example.png"
                alt="JSP Example Usage"
                width={800}
                height={450}
                className="my-4"
              />
